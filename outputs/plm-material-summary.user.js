...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      #${PANEL_ID} .pfh-mini-tool-head > button .pfh-icon svg {
        width: 24px !important;
        height: 24px !important;
        color: inherit !important;
        fill: currentColor !important;
