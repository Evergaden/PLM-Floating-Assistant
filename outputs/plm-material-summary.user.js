...
(function () {
  ...
  function renderSkuList(panel) {
    ...
    const listHead = '<div class="pfh-list-head pfh-page-header"><button type="button" class="pfh-page-back pfh-btn-icon" data-action="home-back" aria-label="\u8fd4\u56de\u4e3b\u9875">' + iconHtml('backArrow') + '</button><strong>' + listTitle + '</strong><span>\u5171 ' + allItems.length + ' \u6761</span></div>' + listTools;
  ...
  function unitConverterViewHtml() {
    ...
    return '<div class="pfh-detail-scroll"><section class="pfh-mini-tool-page">' +
      '<div class="pfh-mini-tool-head pfh-page-header"><button type="button" class="pfh-page-back pfh-btn-icon" data-action="home-back" aria-label="返回主页">' + iconHtml('backArrow') + '</button><div><small>UNIT CONVERTER</small><h2>厘米换算英寸</h2><p>支持单个数值或多个尺寸，例如 3.3 × 3.3 × 12.6。</p></div></div>' +
  ...
  function toolsViewHtml() {
    ...
    return '<div class="pfh-detail-scroll"><section class="pfh-mini-tool-page">' +
      '<div class="pfh-mini-tool-head pfh-page-header"><button type="button" class="pfh-page-back pfh-btn-icon" data-action="home-back" aria-label="返回主页">' + iconHtml('backArrow') + '</button><div><small>QUICK TOOLS</small><h2>小工具</h2><p>把多个编码整理为文件搜索格式。</p></div></div>' +
  ...
  function sizeImageViewHtml() {
    ...
    return '<div class="pfh-detail-scroll pfh-size-image-scroll"><section class="pfh-size-image-page">' +
      ...
      '<div class="pfh-size-image-workspace' + (busy ? ' is-busy' : '') + '"><div class="pfh-size-image-controls">' +
        ...
        '<button type="button" class="pfh-dropzone is-large pfh-size-image-drop' + (busy ? ' is-processing' : '') + '" data-action="size-image-pick"' + disabled + '>' + (busy ? '<i class="pfh-size-image-spinner"></i>' : iconHtml('upload')) + '<strong>' + (busy ? escapeHtml(session.processingStep || '\u6b63\u5728\u5206\u6790\u5e76\u751f\u6210...') : '\u70b9\u51fb\u9009\u62e9\u6216\u62d6\u5165\u56fe\u7247') + '</strong><span>' + (busy ? '\u8bf7\u7a0d\u5019\uff0c\u5927\u5c3a\u5bf8\u56fe\u7247\u9700\u8981\u51e0\u79d2\u5904\u7406\u65f6\u95f4\u3002' : '\u9f20\u6807\u505c\u5728\u8fd9\u91cc\u53ef\u76f4\u63a5 Ctrl+V \u7c98\u8d34\u56fe\u7247\u3002\u7eb8\u76d2\u7528\u900f\u660e PNG\uff0c\u6807\u7b7e/\u5370\u5237\u652f\u6301 PNG / JPG\u3002') + '</span></button>' +
  ...
  function ledgerViewHtml(records) {
    ...
    return '<div class="pfh-detail-scroll"><section class="pfh-ledger-page">' +
      '<div class="pfh-ledger-hero pfh-page-header"><button type="button" class="pfh-page-back pfh-btn-icon pfh-ledger-back" data-action="home-back" aria-label="返回主页">' + iconHtml('backArrow') + '</button><div><h3>今日工作台</h3><p>按设计分配日期整理出图，定稿后继续跟纸盒、标签和图包。</p></div><span>' + escapeHtml(records.length + ' 条 / ' + month) + '</span></div>' +
  ...
  function uploadPanelHtml() {
    ...
    return '<div class="pfh-detail-scroll pfh-upload-scroll"><section class="pfh-section pfh-upload-section is-open' + (viewingHistory ? ' is-history-view' : '') + '">' +
      '<div class="pfh-section-title pfh-page-header pfh-upload-title"><button type="button" class="pfh-page-back pfh-btn-icon pfh-upload-back" data-action="' + backAction + '" aria-label="' + backLabel + '">' + iconHtml('backArrow') + '</button><h3>' + escapeHtml(L.uploadSection) + '</h3>' +
      ...
      '<div class="pfh-upload-body">' +
        (viewingHistory ? '' : uploadModeTabs + (state.uploadMode === 'toy-label'
          ...
          : '<div class="pfh-dropzone is-compact pfh-upload-drop" data-action="upload-pick" data-upload-drop="any" tabindex="0" role="button" aria-label="' + escapeHtml(L.uploadDropHint) + '">' + escapeHtml(L.uploadDropHint) + '</div>' +
