...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      #${PANEL_ID} .pfh-ledger-back:hover {
        color: #6d35e8 !important;
        border-color: rgba(124,58,237,.16) !important;
        background: rgba(124,58,237,.10) !important;
        box-shadow: inset 0 1px 0 rgba(255,255,255,.82), 0 8px 18px rgba(124,58,237,.10) !important;
      }
      #${PANEL_ID} .pfh-ledger-back .pfh-icon,
      #${PANEL_ID} .pfh-ledger-back .pfh-icon-backArrow {
        display: grid !important;
        place-items: center !important;
        width: 18px !important;
        height: 18px !important;
      ...
      #${PANEL_ID} .pfh-ledger-back .pfh-icon svg {
        width: 18px !important;
        height: 18px !important;
        fill: currentColor !important;
        stroke: none !important;
      ...
      #${PANEL_ID} .pfh-size-image-match-list {
        display: grid;
        gap: 8px;
        padding: 12px;
      ...
      #${PANEL_ID} .pfh-size-image-match-list > strong {
        color: #312e81;
        font-size: 13px;
      }
      #${PANEL_ID} .pfh-size-image-match-list > div {
        display: grid;
        grid-template-columns: minmax(90px,1fr) minmax(150px,1.25fr) auto;
        align-items: center;
        gap: 8px;
      }
      #${PANEL_ID} .pfh-size-image-match-list span {
        overflow: hidden;
        color: #64748b;
        font-size: 12px;
        text-overflow: ellipsis;
      ...
      #${PANEL_ID} .pfh-size-image-match-list select,
      #${PANEL_ID} .pfh-size-image-match-list button {
        min-height: 34px;
      ...
      #${PANEL_ID} .pfh-sku-sort-menu .pfh-export-menu-button {
        display: inline-flex;
        align-items: center;
        justify-content: space-between;
        width: 100%;
        ...
        border: 1px solid rgba(167,139,250,.34);
        border-radius: 12px;
        background: linear-gradient(180deg, rgba(255,255,255,.94), rgba(246,243,255,.86));
        box-shadow: inset 0 1px 0 rgba(255,255,255,.96), 0 6px 16px rgba(124,58,237,.08);
        color: #443075;
        font-size: 10px;
        font-weight: 600;
        line-height: 1;
      ...
      #${PANEL_ID} .pfh-sku-sort-menu .pfh-export-menu-list {
        min-width: 100%;
        box-sizing: border-box;
      }
