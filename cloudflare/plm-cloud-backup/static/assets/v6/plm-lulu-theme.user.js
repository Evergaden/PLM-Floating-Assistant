...
// @version      1.5.0
// @description  可选的噜噜乐园皮肤资源：趋势卡片趴趴轮换彩蛋、详情卡片和任务空态优化。
// @author       Violet
// @match        https://plm.westmonth.com/*
// @match        https://auth.westmonth.com/*
// @downloadURL  https://plm-cloud-backup.wt196731.workers.dev/assets/v6/plm-lulu-theme.user.js
// @updateURL    https://plm-cloud-backup.wt196731.workers.dev/assets/v6/plm-lulu-theme.user.js
...
(function () {
  ...
  const LULU_SKIN_CSS = `
    ...
    #plm-floating-helper[data-pfh-theme="lulu"] .pfh-home-entry-primary .pfh-home-entry-meta {
      ...
      border-color: rgba(189, 106, 32, .22) !important;
    ...
    #plm-floating-helper[data-pfh-theme="lulu"] .pfh-home-task-empty > span {
    ...
    #plm-floating-helper[data-pfh-theme="lulu"] .pfh-home-task-empty > span .pfh-icon {
      background: transparent !important;
      border: 0 !important;
      border-radius: 0 !important;
      box-shadow: none !important;
